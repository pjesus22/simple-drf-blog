...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CategoryViewSet, "list", "OPTIONS", False, [WriteThrottle]),
        (CategoryViewSet, "list", "OPTIONS", True, [WriteThrottle]),
        ...
        (TagViewSet, "list", "OPTIONS", False, [WriteThrottle]),
        (TagViewSet, "list", "OPTIONS", True, [WriteThrottle]),
        ...
        (PostViewSet, "list", "OPTIONS", False, [WriteThrottle]),
        (PostViewSet, "list", "OPTIONS", True, [WriteThrottle]),
